...
class Pix2Pix():
    def __init__(self):
        ...
        self.dataset_name = 'artworks'
        path = './data/colorgen_4/'
        ...
        # Generators
        self.data_loader = DataGenerator(partition['train'], labels, path_csv,**params)
...
#                                       img_res=(self.img_rows, self.img_cols))
        ...
        self.frozen_D = self.build_discriminator()
    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            for batch_i in range(self.data_loader.n_batches):
                imgs_B, imgs_A = self.data_loader.__getitem__(batch_i)
    ...
    def sample_images(self, epoch, batch_i):
        ...
        imgs_B, imgs_A = self.data_loader.__getitem__(np.random.randint(0, 500))
